...
const PromptCard = ({ post, handleTagClick, handleEdit, handleDelete }) => {
    ...
    return (
        <div className='prompt_card'>
            <div className="flex lex-justify-between items-start gap-5">
            ...
            <p className='font-inter text-sm blue_gradient cursor-poniter' onClick={() => handleTagClick && handleTagClick(post.tag)}>
                {post.tag}
            </p>
